...
function updateTodoRate(){
	...
	$.ajax({
		type: "POST",
		url: "service/todoUpdateRate.php",
		dataType: 'json',
		data: sendData, 
		success: function(json)
		{
...
function todoPageBuilder(){
	$.ajax({
		type: "POST",
		url: "service/todoRetreiveAll.php",
		dataType: 'json',
		success: function(json)
		{
			//console.log(JSON.stringify(json)); // show response from the php script.
